...
const LOG_COLORS_DARK_MODE = new Map([
...
const LOG_COLORS_LIGHT_MODE = new Map([
...
export const useLogEntryColor = (severity) => {
    var _a;
    const isDarkMode = useIsDarkMode();
    const colors = isDarkMode ? LOG_COLORS_DARK_MODE : LOG_COLORS_LIGHT_MODE;
    return (_a = colors.get(severity)) !== null && _a !== void 0 ? _a : 'orange';
};
//# sourceMappingURL=use-log-entry-color.js.map