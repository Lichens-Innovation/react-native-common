...
const bundleId = Platform.select({
    ios: (_b = (_a = Constants.expoConfig) === null || _a === void 0 ? void 0 : _a.ios) === null || _b === void 0 ? void 0 : _b.bundleIdentifier,
    android: (_d = (_c = Constants.expoConfig) === null || _c === void 0 ? void 0 : _c.android) === null || _d === void 0 ? void 0 : _d.package,
    default: 'com.rinnovision.app',
});
const appName = bundleId === null || bundleId === void 0 ? void 0 : bundleId.split('.').pop();
const logFilenamePrefix = `app-logs-${appName}`;
const logFilenamePattern = `${logFilenamePrefix}-{date-today}.txt`;
const filePath = (_e = nativeFileSystem.documentDirectory) !== null && _e !== void 0 ? _e : '';
class LoggerWrapper {
    constructor(config) {
...
const getTransports = () => {
    const transports = [fileAsyncTransport, commonLogsStoreTransport];
...
export const loadAllLogFilesInfo = async () => {
    try {
        ...
        return fileInfos
            .filter((info) => !!(info === null || info === void 0 ? void 0 : info.exists)) // only files that exist
            .sort((a, b) => { var _a, _b; return ((_a = b.modificationTime) !== null && _a !== void 0 ? _a : 0) - ((_b = a.modificationTime) !== null && _b !== void 0 ? _b : 0); }); // most recent logs on top
    }
    catch (e) {
...
export const loadCurrentLogsFileUri = async () => {
    ...
    return (_b = (_a = fileInfos[0]) === null || _a === void 0 ? void 0 : _a.uri) !== null && _b !== void 0 ? _b : '';
};
